...
- **Use `Skeleton`** for tiny inline placeholders only. Layout-accurate list/card/page loading → `LayoutSkeleton` (`boneyard-skeletons.mdc`). No custom `animate-pulse` divs.
